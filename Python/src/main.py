...
def create_args():
    ...
    # --- Input paths ---
    parser.add_argument('--input_path', default="../data/60_tracks2vehicle.csv", type=str,
                        help='CSV file of the tracks')
    parser.add_argument('--input_static_path', default="../data/60_tracksMeta.csv",
                        type=str,
                        help='Static meta data file for each track')
    parser.add_argument('--input_meta_path', default="../data/60_recordingMeta.csv",
                        type=str,
                        help='Static meta data file for the whole video')
    parser.add_argument('--pickle_path', default="../data/60.pickle", type=str,
    ...
    parser.add_argument('--background_image', default="../data/60_highway.png", type=str,
